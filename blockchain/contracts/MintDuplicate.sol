...
contract MintDuplicate is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public constant maxSupply = 1000; // total NFT
    ...
    address public FeeReceiver = 0x3c3cb22D555523bb85f2a76CBFF8ACBBb54332dc;
    ...
    function updateImageURI(string memory imageURI_) public onlyOwner {
        _imageURI = imageURI_;
    }
    ...
    function _updateMintedList(address receiver, uint256 tokenId, uint256 amount) private {
        ...
        mintedNft.push(MintedNftStruct(tokenId, receiver, amount, _imageURI, timestamp));
    }
