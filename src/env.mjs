...
const client = z.object({
  NEXT_PUBLIC_WALLET: z.enum(["metamask"]).optional(),
  NEXT_PUBLIC_NETWORK_NAME: z.string().optional(),
  NEXT_PUBLIC_CHAIN_ID: z.string().optional(),
  NEXT_PUBLIC_NEW_RPC_URL: z.string().url().optional(),
  NEXT_PUBLIC_SYMBOL: z.string().optional(),
  NEXT_PUBLIC_CURRENCY_DECIMALS: z.string().optional(),
});
